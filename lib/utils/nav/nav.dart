...
import 'package:marine_watch/utils/nav/delegate.dart';

/// allow you to interact with the List of [pages]
class CustomNavConfig extends ChangeNotifier {
  CustomNavConfig({required this.routes, this.pageNotFound});

  final Map<String, CustomPageBuilder> routes;
  final CustomPageBuilder? pageNotFound;
